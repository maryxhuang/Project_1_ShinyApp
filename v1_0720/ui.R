  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "details", 
              tabsetPanel(
                tabPanel("Age", 
                         fluidRow(column(7, plotOutput("age_all_line")),
                                  column(5, textOutput("age18_all"))), 
                         fluidRow(textOutput("age_spe_mean"), 
                                  plotOutput("age_spe_barperc"))), 
                tabPanel("Sex", 
                         fluidRow(plotOutput("sex_all_pie")), 
                         fluidRow(plotOutput("sex_spe_pie"))),
                tabPanel("Weapon", 
